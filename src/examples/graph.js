...
class Graph extends React.Component<IGraphProps, IGraphState> {
  ...
  getDiagrams = () => {
    ...
    axios.get('http://35.239.181.229/diagrams')
  ...
  deleteDiagram = () => {
    ...
    if(this.state.graph._id){ // Actualizar grafo existente
      axios.delete('http://35.239.181.229/diagrams/'+this.state.graph._id)
      .then(function (response) {
  ...
  updateDiagram () {
    const _this = this;
    return axios.put('http://35.239.181.229/diagrams/'+this.state.graph._id, this.state.graph)
    .then((response) => {
  ...
  saveDiagram () {
    const _this = this;
    return axios.post('http://35.239.181.229/diagrams', this.state.graph)
    .then((response) => {
  ...
  calculateDijkstra (id) {
    ...
    return axios.post('http://35.239.181.229/dijkstra/'+ id, data)
    .then((response) => {
